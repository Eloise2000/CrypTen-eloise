...
try:
    from crypten_eloise.nn.tensorboard import SummaryWriter
...
def run_experiment(
    ...
    encrypted_model = crypten_eloise.nn.from_pytorch(model, dummy_input=dummy_input)
    ...
    for idx, sample in enumerate(dataset):
        ...
        encrypted_image = crypten_eloise.cryptensor(image)
