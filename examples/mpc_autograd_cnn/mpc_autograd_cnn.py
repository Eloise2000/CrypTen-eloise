...
def run_mpc_autograd_cnn(
    ...
    # encrypt
    x_alice_enc = crypten_eloise.cryptensor(x_alice, src=0)
    x_bob_enc = crypten_eloise.cryptensor(x_bob, src=1)

    # combine feature sets
    x_combined_enc = crypten_eloise.cat([x_alice_enc, x_bob_enc], dim=2)
...
def train_encrypted(
    ...
    for epoch in range(num_epochs):
        ...
        for j in range(0, num_samples, batch_size):
            ...
            y_train = crypten_eloise.cryptensor(y_one_hot, requires_grad=True)
