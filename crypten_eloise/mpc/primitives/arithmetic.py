...
# dependencies:
import torch
from crypten_eloise.common.functions import regular
from crypten_eloise.common.rng import generate_random_ring_element
from crypten_eloise.common.tensor_types import is_float_tensor, is_int_tensor, is_tensor
from crypten_eloise.common.util import torch_stack
from crypten_eloise.config import cfg
from crypten_eloise.cryptensor import CrypTensor
from crypten_eloise.cuda import CUDALongTensor
...
class ArithmeticSharedTensor:
    ...
    def PRZS(*size, device=None):
        ...
        """
        from crypten_eloise import generators
