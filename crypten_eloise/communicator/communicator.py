...
class Communicator:
    ...
    def print_communication_stats(self):
        ...
        crypten_eloise.log("====Communication Stats====")
        crypten_eloise.log("Rounds: {}".format(self.comm_rounds))
        crypten_eloise.log("Bytes: {}".format(self.comm_bytes))
        crypten_eloise.log("Communication time: {}".format(self.comm_time))
