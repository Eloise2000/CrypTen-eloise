...
from crypten_eloise.nn import onnx_converter
...
class TestOnnxConverter:
    ...
    def test_from_pytorch_training_classification(self):
        ...
        for loss_name in ["BCELoss", "CrossEntropyLoss"]:
            ...
            model = crypten_eloise.nn.from_pytorch(model_plaintext, dummy_input)
            model.train()
            model.encrypt()
    ...
    def test_from_pytorch_training_regression(self):
        ...
        x_train = crypten_eloise.cryptensor(x_orig, requires_grad=True)
        y_train = crypten_eloise.cryptensor(y_orig.unsqueeze(-1))
    ...
    def test_get_operator_class(self):
        ...
        for op_type in op_types:
            ...
            self.assertTrue(
                issubclass(operator, crypten_eloise.nn.Module),
